...
aggBaseModel <- function(lambda=c(0,0,0,0,0,0),tPeriods=6,lDays=c(22,22,22,22,22,22),W0=0,I0=0,B0=0,wages=0,hire=0,fire=0,hold=0,backOrder=0,pCost=0,pLastPeriod=0,wLastPeriod=0,dLastPeriod=0){
  ...
  aggPlan = lp(direction = "min",
               objective.in = objF, 
               const.mat = lpMatrix, 
               const.dir = c(initialSigns,workersSigns,inventorySigns,productionSigns),
...
aggLevelWorkforce <- function(lambda=c(0,0,0,0,0,0),tPeriods=6,lDays=c(22,22,22,22,22,22),W0=0,I0=0,B0=0,wages=0,hire=0,fire=0,hold=0,backOrder=0,pCost=0,pLastPeriod=0,wLastPeriod=0,dLastPeriod=0,levelWf=0){
  ...
  aggPlan = lp(direction = "min",
               objective.in = objF, 
               const.mat = lpMatrix, 
               const.dir = c(initialSigns,workersSigns,inventorySigns,productionSigns,invBackSigns), 
...
aggProdPlan <- function(lambda=c(0,0,0,0,0,0),tPeriods=6,lDays=c(22,22,22,22,22,22),W0=0,I0=0,B0=0,wages=0,hire=0,fire=0,hold=0,backOrder=0,pCost=0,pLastPeriod=0,wLastPeriod=0,dLastPeriod=0,levelWf=0,mode=1){
  
  aggPlan=switch (mode,
                  aggBaseModel(lambda,tPeriods,lDays,W0,I0,B0,wages,hire,fire,hold,backOrder,pCost,pLastPeriod,wLastPeriod,dLastPeriod),
                  aggLevelWorkforce(lambda,tPeriods,lDays,W0,I0,B0,wages,hire,fire,hold,backOrder,pCost,pLastPeriod,wLastPeriod,dLastPeriod,levelWf),
                  aggNoBackorder(lambda,tPeriods,lDays,W0,I0,B0,wages,hire,fire,hold,backOrder,pCost,pLastPeriod,wLastPeriod,dLastPeriod,levelWf),
                  aggZeroInvBack(lambda,tPeriods,lDays,W0,I0,B0,wages,hire,fire,hold,backOrder,pCost,pLastPeriod,wLastPeriod,dLastPeriod)
  )
